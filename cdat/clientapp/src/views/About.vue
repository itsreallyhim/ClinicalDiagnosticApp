<template>
  <div class="about">
    <h1 class="mb-4 text-2xl">
      Global Back Care Online Clinical Diagnostic Assessment
    </h1>
      ...
      <div class=" sm:col-span-2">
        <div class="p-4 bg-white">
          ...
          <p class="mb-2">
            ...
            fitness and allied health practitioners to work out which muscles
            are responsible for taking your skeleton out of alignment.
          </p>
          ...
          <h2>Put yourself in charge of your own musculo-skeletal health</h2>
          <p class="mb-2">
            You've already viewed the sample template. You're now ready to
            complete the online version. Register using the link at the top of
            the page, or Login.
          </p>
          ...
          <p class="mb-2">
            ...
            flexibility and strength exercises you need to do to get your
            skeleton back into better alignment - and your lower back pain free.
          </p>
        ...
        <div class="p-4 mt-4 text-sm bg-white">
          <p>&copy; 2020 | Global Back Care</p>
        </div>
      </div>
      <img src="@/assets/Backpain.jpg" alt="Back Pain" />
    </div>
  </div>
</template>
